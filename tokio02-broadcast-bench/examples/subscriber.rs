...
use tokio_util::codec::length_delimited::Builder as LengthDelimitedCodecBuilder;
...
fn main() {
    ...
    'outer: for i in 0..n_threads {
        ...
        for j in 0..n_subscribers_per_thread {
            ...
            handles.push(rt.spawn(async move {
                ...
                let mut framed = LengthDelimitedCodecBuilder::new()
    ...
    rt.block_on(handles.pop().unwrap()).unwrap();
}
